...
function Click(id) {
  ...
  if (win) {
    var mess = "Bạn đã bị bắt lại tịnh thất bồng lai";
    if (pwin == 0) mess = "Giải cứu thành công Diễm My";
    alert(mess);
    InGame = false;
  } else {
...
function LoadProgress() {
  ...
  setTimeout(function () {
    ...
    if (pgr.value > 0) LoadProgress();
      ...
      var mess = "Bạn đã bị bắt ở lại tịnh thất Bồng Lai";
      if (CPlayer == 1) mess = "Giải cứu thành công Diễm My";
      alert(mess);
      InGame = false;
    }
  }, 100);
